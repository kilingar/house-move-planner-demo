export default {
  ...
  icon: "🚿",
  items: [
    { id: "bathroom-plan-check-walls", type: "plan", text: "Walls and ceiling are plastered, smooth, and ready for primer and paint", tasks: ["provisional-acceptance"] },
    ...
    { id: "bathroom-buy-curtains", type: "buy", group: "Textiles & Decor", text: "Alternate day-night curtains" },
    { id: "bathroom-buy-column", type: "buy", group: "IKEA", text: "Bathroom furniture - one vertical column floating - black", tasks: ["ikea-pax"] },
    { id: "bathroom-buy-silicone", type: "buy", group: "Plumbing", text: "Silicone sealant for wet areas" },
    { id: "bathroom-buy-carpet", type: "buy", group: "Textiles & Decor", text: "Carpet or rug for bathroom floor" },
    { id: "bathroom-do-column-height", type: "do", text: "Confirm final fixing heights for the floating storage column before drilling", tasks: ["ikea-pax"] },
    { id: "bathroom-do-install-column", type: "do", text: "Install the floating storage column with fixings suitable for the wall type", tasks: ["ikea-pax"] },
