export default {
  ...
  icon: "🚪",
  items: [
    { id: "upstairs-plan-check-walls", type: "plan", text: "Walls and ceiling are plastered, smooth, and ready for primer and paint", tasks: ["provisional-acceptance"] },
    ...
    { id: "upstairs-buy-pax", type: "buy", group: "IKEA", text: "IKEA PAX frames and interior fittings for Upstairs Corridor", tasks: ["ikea-pax"] },
    { id: "upstairs-buy-anchors", type: "buy", group: "IKEA", text: "Wall anchors and screws by wall type", tasks: ["ikea-pax"] },
